...
class LocationRankingClanLocationTest {

  private LocationRankingClanLocation unitUnderTest;

  @BeforeEach
  void setUp() {
    unitUnderTest = new LocationRankingClanLocation();
  }
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    String expected = "LocationRankingClanLocation(country=false, countryCode=astring, id=815, name=astring)";
