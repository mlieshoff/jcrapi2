...
class LocationRankingClanTest {
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    String expected = "LocationRankingClan(tag=astring, name=astring, rank=815, previousRank=815, location=" + new LocationRankingClanLocation() + ", clanScore=815, badgeId=815, members=815)";
