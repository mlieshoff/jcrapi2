 ...
 */
@Getter
public class GetClanRiverRaceLogRequest extends PageableRequest<GetClanWarLogResponse> {

  private final String clanTag;

  @Builder
  private GetClanRiverRaceLogRequest(Callback<GetClanWarLogResponse> callback, int limit, String after, String before,
                                     String clanTag) {
