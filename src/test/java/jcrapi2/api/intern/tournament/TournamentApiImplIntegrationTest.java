...
public class TournamentApiImplIntegrationTest extends IntegrationTestBase {
  ...
  void findAll_whenWithException() {
    ...
    prepareWithErrorAndRun("/tournaments".replace("{name}", String.valueOf(name)), "name=" + name + "", request,
  ...
  void findByTag() throws Exception {
    ...
    jcrapi2.api.intern.tournaments.info.TournamentRequest request = builder
        ...
        .storeRawResponse(true)
        .build();
    prepare("/tournaments/{tournamentTag}".replace("{tournamentTag}", String.valueOf(tournamentTag)), "",
  ...
  void findByTag_whenWithException() {
    ...
    prepareWithErrorAndRun("/tournaments/{tournamentTag}".replace("{tournamentTag}", String.valueOf(tournamentTag)), "",
        request, () -> unitUnderTest.findByTag(request).get());
  }
