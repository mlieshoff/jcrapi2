...
public class GetLocationRequest extends Request<GetLocationResponse> {
  ...
  @Builder
  private GetLocationRequest(Callback<GetLocationResponse> callback, String locationId) {
    super(callback);
  ...
  public static GetLocationRequest.GetLocationRequestBuilder builder(String locationId) {
    return new GetLocationRequest.GetLocationRequestBuilder().locationId(locationId);
  }
