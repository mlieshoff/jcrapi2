...
class PlayerBattleLogTeamTest {
  ...
  void setCards_whenWithValidParameter_thenSetCards() {
    List<PlayerBattleLogTeamCard> expected = new ArrayList<PlayerBattleLogTeamCard>();
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    unitUnderTest.setCards(new ArrayList<PlayerBattleLogTeamCard>());
    ...
    String expected = "PlayerBattleLogTeam(cards=" + new ArrayList<PlayerBattleLogTeamCard>() + ", clan=" + new PlayerBattleLogTeamClan() + ", crowns=815, kingTowerHitPoints=815, name=astring, princessTowersHitPoints=" + new ArrayList<Integer>() + ", startingTrophies=815, tag=astring, trophyChange=815)";
