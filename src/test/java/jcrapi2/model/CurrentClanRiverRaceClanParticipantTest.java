...
class CurrentClanRiverRaceClanParticipantTest {
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    String expected = "CurrentClanRiverRaceClanParticipant(boatAttacks=815, decksUsed=815, decksUsedToday=815, fame=815, name=astring, repairPoints=815, tag=astring)";
