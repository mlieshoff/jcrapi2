...
class LocationRankingClanTest {

  private LocationRankingClan unitUnderTest;

  @BeforeEach
  void setUp() {
    unitUnderTest = new LocationRankingClan();
  }
  ...
  void setLocation_whenWithValidParameter_thenSetLocation() {
    LocationRankingClanLocation expected = new LocationRankingClanLocation();
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    unitUnderTest.setLocation(new LocationRankingClanLocation());
    unitUnderTest.setMembers(815);
    unitUnderTest.setName("astring");
    unitUnderTest.setPreviousRank(815);
    unitUnderTest.setRank(815);
    unitUnderTest.setTag("astring");
    String expected = "LocationRankingClan(badgeId=815, clanScore=815, location=" + new LocationRankingClanLocation() + ", members=815, name=astring, previousRank=815, rank=815, tag=astring)";
