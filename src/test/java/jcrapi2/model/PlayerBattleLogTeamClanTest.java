...
class PlayerBattleLogTeamClanTest {

  private PlayerBattleLogTeamClan unitUnderTest;

  @BeforeEach
  void setUp() {
    unitUnderTest = new PlayerBattleLogTeamClan();
  }
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    String expected = "PlayerBattleLogTeamClan(badgeId=815, name=astring, tag=astring)";
