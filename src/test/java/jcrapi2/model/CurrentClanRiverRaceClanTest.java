...
class CurrentClanRiverRaceClanTest {

  private CurrentClanRiverRaceClan unitUnderTest;

  @BeforeEach
  void setUp() {
    unitUnderTest = new CurrentClanRiverRaceClan();
  }
  ...
  void setParticipants_whenWithValidParameter_thenSetParticipants() {
    List<CurrentClanRiverRaceClanParticipant> expected = new ArrayList<CurrentClanRiverRaceClanParticipant>();
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    String expected = "CurrentClanRiverRaceClan(badgeId=815, clanScore=815, fame=815, finishTime=astring, name=astring, participants=" + new ArrayList<CurrentClanRiverRaceClanParticipant>() + ", periodPoints=815, repairPoints=815, tag=astring)";
