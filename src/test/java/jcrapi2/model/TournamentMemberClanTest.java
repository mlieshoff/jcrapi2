...
class TournamentMemberClanTest {

  private TournamentMemberClan unitUnderTest;

  @BeforeEach
  void setUp() {
    unitUnderTest = new TournamentMemberClan();
  }
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    String expected = "TournamentMemberClan(tag=astring, name=astring, badgeId=815)";
