...
class ClanRiverRaceLogStandingClanParticipantTest {

  private ClanRiverRaceLogStandingClanParticipant unitUnderTest;

  @BeforeEach
  void setUp() {
    unitUnderTest = new ClanRiverRaceLogStandingClanParticipant();
  }
  ...
  void toString_whenCalled_thenReturnStringRepresentation() {
    ...
    String expected = "ClanRiverRaceLogStandingClanParticipant(fame=815, name=astring, repairPoints=815, tag=astring)";
