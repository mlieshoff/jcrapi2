...
public class ClanApiImplIntegrationTest extends IntegrationTestBase {
  ...
  void findAll_whenWithException() {
    ...
    prepareWithErrorAndRun(
        "/clans".replace("{name}", String.valueOf(name)).replace("{locationId}", String.valueOf(locationId))
            .replace("{minMembers}", String.valueOf(minMembers)).replace("{maxMembers}", String.valueOf(maxMembers)),
        "name=" + name + "&locationId=" + locationId + "&minMembers=" + minMembers + "&maxMembers=" + maxMembers + "",
  ...
  void findByTag() throws Exception {
    ...
    jcrapi2.api.intern.clans.info.ClanRequest request = builder
        ...
        .storeRawResponse(true)
        .build();
    prepare("/clans/{clanTag}".replace("{clanTag}", String.valueOf(clanTag)), "",
        "src/test/resources/clan-findByTag.json", request);
  ...
  void findByTag_whenWithException() {
    ...
    prepareWithErrorAndRun("/clans/{clanTag}".replace("{clanTag}", String.valueOf(clanTag)), "", request,
  ...
  void getRiverRaceLog() throws Exception {
    ...
    jcrapi2.api.intern.clans.riverracelog.RiverRaceLogRequest request = builder
        ...
        .storeRawResponse(true)
        .build();
    prepare("/clans/{clanTag}/riverracelog".replace("{clanTag}", String.valueOf(clanTag)), "",
  ...
  void getRiverRaceLog_whenWithException() {
    ...
    prepareWithErrorAndRun("/clans/{clanTag}/riverracelog".replace("{clanTag}", String.valueOf(clanTag)), "", request,
  ...
  void getMembers() throws Exception {
    ...
    jcrapi2.api.intern.clans.members.ClanMembersRequest request = builder
        ...
        .storeRawResponse(true)
        .build();
    prepare("/clans/{clanTag}/members".replace("{clanTag}", String.valueOf(clanTag)), "",
        "src/test/resources/clan-getMembers.json", request);
  ...
  void getMembers_whenWithException() {
    ...
    prepareWithErrorAndRun("/clans/{clanTag}/members".replace("{clanTag}", String.valueOf(clanTag)), "", request,
  ...
  void getCurrentRiverRace() throws Exception {
    ...
    jcrapi2.api.intern.clans.currentriverrace.CurrentRiverRaceRequest request = builder
        ...
        .storeRawResponse(true)
        .build();
    prepare("/clans/{clanTag}/currentriverrace".replace("{clanTag}", String.valueOf(clanTag)), "",
  ...
  void getCurrentRiverRace_whenWithException() {
    ...
    prepareWithErrorAndRun("/clans/{clanTag}/currentriverrace".replace("{clanTag}", String.valueOf(clanTag)), "",
        request, () -> unitUnderTest.getCurrentRiverRace(request).get());
  }
