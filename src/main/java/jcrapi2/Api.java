...
public class Api {
  ...
  public GetClanRiverRaceLogResponse getClanRiverRaceLog(GetClanRiverRaceLogRequest getClanRiverRaceLogRequest) {
    checkNotNull(getClanRiverRaceLogRequest, "getClanRiverRaceLogRequest");
    try {
      return createClient().getClanRiverRaceLog(getClanRiverRaceLogRequest);
    } catch (IOException e) {
      throw new ApiException(e);
    }
  }
